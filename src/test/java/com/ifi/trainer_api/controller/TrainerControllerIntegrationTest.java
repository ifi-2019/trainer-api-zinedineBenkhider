...
public class TrainerControllerIntegrationTest {
    ...
    void deleteTrainer_shouldDeleteAshAndMisty() {
        ...
        restTemplate.postForObject("http://localhost:" + port + "/trainers/",ash,Trainer.class);
    ...
    void AddTrainer_ShouldChangeSizeOfGetAllTrainers() {
        ...
        restTemplate.postForObject("http://localhost:" + port + "/trainers/",newTrainer,Trainer.class);

        Trainer newTrainerGet = this.restTemplate.getForObject("http://localhost:" + port + "/trainers/New", Trainer.class);
